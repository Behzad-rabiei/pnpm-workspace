...
- **Deployment**: Watchtower auto-pulls `latest` tagged images
...
| `IMAGE_TAG`        | Docker image tag                | `latest` / `production`     |
...
- **Production**: `production` (manually promoted from staging)
